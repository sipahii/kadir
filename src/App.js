...
import LengthJewelPage from "./Admin-pannel/Pages/lengthJewelPage";
import AddLengthJewelPage from "./Admin-pannel/Pages/addLengthJewelPage";
import EditLengthJewelPage from "./Admin-pannel/Pages/editLengthJewelPage";
import AlphabetJewelPage from "./Admin-pannel/Pages/AlphabetJewelPage";
import AddAlphabetJewelPage from "./Admin-pannel/Pages/addAlphabetJewelPage";
import EditAlphabetJewelPage from "./Admin-pannel/Pages/editAlphabetJewelPage";
import CuratedByJewelPage from "./Admin-pannel/Pages/curatedByJewelPage";
import AddCuratedByJewelPage from "./Admin-pannel/Pages/addCuratedByJewelPage";
import EditCuratedByJewelPage from "./Admin-pannel/Pages/editCuratedByJewelPage";
import GoogleAnalyticsCelebrityDashboard from "./Admin-pannel/Pages/googleAnalyticsCelebrityDasboardPage";
import GoogleAnalyticsCelebrityDashboardPage from "./Admin-pannel/Pages/googleAnalyticsCelebrityDasboardPage";
import MGCDashboardPage from "./Admin-pannel/Pages/mgcDashboadPage";
import OtpPage from "./Admin-pannel/Pages/otpPage";
import CelebrityDetailPage from "./Admin-pannel/Pages/celeberityDetailPage";
import AddEditCloudinaryCredentialPage from "./Admin-pannel/Pages/addEditcloudinaryCredentialPage";
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          />
          <Route path="cloudinary-credential" element={<AddEditCloudinaryCredentialPage />} />
          ...
          <Route path="add-jewel-length" element={<AddLengthJewelPage />} />
          <Route path="jewel-length" element={<LengthJewelPage />} />
          <Route path="jewel-length/edit/:uid" element={<EditLengthJewelPage />} />
          <Route path="add-alphabet" element={<AddAlphabetJewelPage />} />
          <Route path="jewel-alphabet" element={<AlphabetJewelPage />} />
          <Route path="jewel-alphabet/edit/:uid" element={<EditAlphabetJewelPage />} />
          <Route path="add-curatedby" element={<AddCuratedByJewelPage />} />
          <Route path="curatedby" element={<CuratedByJewelPage />} />
          <Route path="curatedby/edit/:uid" element={<EditCuratedByJewelPage />} />
          ...
          <Route path="list-celebrity/detail/:id" element={<CelebrityDetailPage />} />
          <Route
          ...
          <Route
            ...
            element={<GoogleAnalyticsCelebrityDashboardPage />}
          />
          <Route
            path="mgc-dashboard"
            element={<MGCDashboardPage />}
          />

        ...
        <>
            <div className="card shadow-none bg-light">
                <div className="card-header">
                    <h6 className="mb-0">Payment Methods Widget</h6>
                </div>
                <div className="card-body">
                    <div className="form-group">
                        <label>Payment Methods</label>
                        <div className="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true" onClick={handleShow}>
                            ...
                            <input type="hidden" name="types[]" defaultValue="payment_method_images" />
                            <input type="hidden" name="payment_method_images" className="selected-files" defaultValue />
                        </div>

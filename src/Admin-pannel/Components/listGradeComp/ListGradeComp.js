...
import { useCatagaryActiveMutation, useDeleteClebrityGradeMutation, useGetCelebrityGradeQuery, } from "../all-products/allproductsApi/allProductsApi";
import { ToastContainer, toast } from "react-toastify";


function ListGradeComp() {
    const [inputVal, setInputVal] = useState({ search: '' });
    const [blankArr, setBlankArr] = useState([]);

    const token = window.localStorage.getItem('token')
    const { isLoading, data, refetch } = useGetCelebrityGradeQuery(token);
    ...
    const [deleteGrade, res] = useDeleteClebrityGradeMutation();
    ...
    const toastErrorMessage = () => {
        toast.error("Grade Update Faild..", {
            position: "top-center"
        })
    };
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">All Grades</h1>
                            </div>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/grade/create" className="btn btn-primary">
                    ...
                    <div className="card">
                        ...
                        <div className="card-header d-block d-md-flex">
                            <h5 className="mb-0 h6">Grades</h5>

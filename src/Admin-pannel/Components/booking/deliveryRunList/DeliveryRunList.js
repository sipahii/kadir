                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Delivery Run Sheet List</h1>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Delivery Run Sheet List</h5>
                        </div>
                                ...
                                <div className="col-lg-6">
                                    <div className="cox-table">
                                        ...
                                        <div className="mb-3 d-flex mainn">
                                            ...
                                            <div className="mb-3 d-flex mainn">
                                                <label htmlFor="exampleInputEmail1 " className="form-label mr-3">DRS No</label>
                                                <input type="date" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                            ...
                            <table className="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-secondary" scope="col">DRS No</th>
                                        ...
                                        <th class="table-secondary" scope="col">Delivery Boy</th>
                                        <th class="table-secondary" scope="col">Vehicle No</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="table-secondary"><input className="form-control tip" type="text" placeholder="Mode" /></td>

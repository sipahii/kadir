...
function AddGemstoneMultiLang({ data, item, i, params, sendData, onChangeHandler, setValue, onChangeThumbnailImage, showImageD, setShowImageD, onChangeHandleExcel }) {
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '3px' }}>
                            <div className="">
                                <h1 className="h3">{params?.uid ? 'Update' : "Add"} Gemstone</h1>
                            </div>
                            <div className=''>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5>{params?.uid ? 'Update' : 'Add'} Gemstone ({item?.lable})</h5>
                        </div>
...
export default AddGemstoneMultiLang
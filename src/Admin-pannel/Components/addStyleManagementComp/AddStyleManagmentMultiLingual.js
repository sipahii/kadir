...
function AddStyleManagmentMultiLingual({ data, item, i, params, onChangeHandler, setValue, bringImage, bringImage1, bringImage2, bringImage3, bringFinalCaetgD, bringFinalProductsD, onchengePhotoHandel, setLoop, addNewAttributeData }) {

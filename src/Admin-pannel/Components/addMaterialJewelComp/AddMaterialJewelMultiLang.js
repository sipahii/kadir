...
function AddMaterialJewelMultiLang({ data, item, i, params, sendData, onChangeHandler, setValue, onChangeThumbnailImage, showImageD, setShowImageD, onChangeHandleExcel }) {
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5>{params?.uid ? 'Update' : 'Add'} Material ({item?.lable})</h5>
                        </div>
...
export default AddMaterialJewelMultiLang
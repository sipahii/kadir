...
function TopNavSeller({ showSidebar }) {
  ...
  const isPickupManagerName = window.localStorage.getItem(
    "isPickupManagerName"
  );
        ...
        <div className="d-flex justify-content-around align-items-center align-items-stretch">
              ...
              >
                <span className="btn btn-icon p-0 d-flex justify-content-center align-items-center">
                  <span className="d-flex align-items-center position-relative">
                    ...
                    <span className="badge badge-sm badge-dot badge-circle badge-primary position-absolute absolute-top-right"></span>
                  </span>
                </span>
              </a>
              <div className="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg py-0">
                ...
                <div className="px-3 c-scrollbar-light overflow-auto ">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item d-flex justify-content-between align-items- py-3">
              ...
              <ul className="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs">
                <li>
                  <a href="#" data-flag="en" className="dropdown-item  active ">
                    <img
                      src="https://mmslfashions.in/public/assets/img/flags/en.png"
                      className="mr-2"
                    />
                ...
                <li>
                  <a href="#" data-flag="bd" className="dropdown-item ">
                    <img
                      src="https://mmslfashions.in/public/assets/img/flags/bd.png"
                      className="mr-2"
                      alt=""
                    />
                ...
                <li>
                  <a href="#" data-flag="sa" className="dropdown-item ">
                    <img
                      src="https://mmslfashions.in/public/assets/img/flags/sa.png"
                      className="mr-2"
                    />
          ...
          <div className="aiz-topbar-item ml-2">
            <div className="align-items-stretch d-flex dropdown">
                ...
                <span className="d-flex align-items-center">
                  <span className="avatar avatar-sm mr-md-2">
                    {/* <img src="https://mmslfashions.in/public/uploads/all/J3IHQMPrIal220S890WP4kxP1shTCJytvopboZrL.png" alt=""
                                    /> */}
                    <img
                      src="https://evehicleform.mshfdc.co.in/static/media/logo-removebg-preview.89aa6ca988e65059e9ff.png"
                      alt=""
                    />
                  </span>
              ...
              <div
                className={`dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md ${
                  show && "show"
                }`}
              >
                {isLoginPickup ? (

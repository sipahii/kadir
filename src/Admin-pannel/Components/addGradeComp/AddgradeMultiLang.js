...
function AddgradeMultiLang({ data, item, i, addNewAttributeData, onChangeHandler, setValue, onChangeHandlesr }) {
    ...
    const getParentCategoryData = async () => {
        const resp = await axios.get(`https://onlineparttimejobs.in/api/influence_gradeMaster/admin`, {
            headers: {
    ...
    return <div className="card">
        <div className="card-header">
            <h5 className="mb-0 h6">Grade Information ({item?.lable})</h5>
        </div>
...
export default AddgradeMultiLang
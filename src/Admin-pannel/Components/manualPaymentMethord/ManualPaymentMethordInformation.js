...
function ManualPaymentMethordInformation() {
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h3 className="mb-0 h6">Manual Payment Information</h3>
              </div>
              <form
                action="https://mmslfashions.in/admin/manual_payment_methods/1"
                method="POST"
              >
  ...
  <option value="2">Check Payment</option>
                      ...
                      {/* <div className="dropdown bootstrap-select form-control aiz-">
                        ...
                        >
                          ...
                          <option value="bank_payment" selected>
                            Bank Payment
                          </option>
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-sm-10">
                      <textarea
                        ...
                        name="description"
                        style={{ display: "none" }}
                        defaultValue={"<p>ICICI Bank Ltd Bank Details<br></p>"}
                      />
                            ...
                            <div className="modal-content">
                              ...
                              <div className="modal-body">
                                <div className="form-group note-form-group">
                                  <label
                                    htmlFor="note-dialog-link-txt-16760334306911"
                                    className="note-form-label"
                                  >
                                    Text to display
                                  </label>
                                  <input
                                    id="note-dialog-link-txt-16760334306911"
                                ...
                                <div className="form-group note-form-group">
                                  <label
                                    htmlFor="note-dialog-link-url-16760334306911"
                                    className="note-form-label"
                                  >
                                    To what URL should this link go?
                                  </label>
                                  <input
                                    id="note-dialog-link-url-16760334306911"
                            ...
                            <div className="modal-content">
                              ...
                              <div className="modal-body">
                                <div className="form-group note-form-group note-group-select-from-files">
                                  <label
                                    htmlFor="note-dialog-image-file-16760334306911"
                                    className="note-form-label"
                                  >
                                    Select from files
                                  </label>
                                  <input
                                    id="note-dialog-image-file-16760334306911"
                                ...
                                <div className="form-group note-group-image-url">
                                  <label
                                    htmlFor="note-dialog-image-url-16760334306911"
                                    className="note-form-label"
                                  >
                                    Image URL
                                  </label>
                                  <input
                                    id="note-dialog-image-url-16760334306911"
                            ...
                            <div className="modal-content">
                              ...
                              <div className="modal-body">
                                <div className="form-group note-form-group row-fluid">
                                  <label
                                    htmlFor="note-dialog-video-url-16760334306911"
                                    className="note-form-label"
                                  >
                                    Video URL{" "}
                                  ...
                                  <input
                                    id="note-dialog-video-url-16760334306911"
                            ...
                            <div className="row">
                              <div className="col-sm-3">
                                <input
                                  ...
                                  defaultValue="ICICI Bank Ltd"
                                  fdprocessedid="qrdacve"
                                />
                              </div>
                              <div className="col-sm-3">
                                <input
...
export default ManualPaymentMethordInformation;

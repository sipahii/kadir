...
import { useAddPaymentGetMutation } from "../all-products/allproductsApi/allProductsApi"

function ManualPaymentMethordCreate() {
  const [show, setShow] = useState(false);
  const [sendBox, setSandBox] = useState(false)

  const handleClose = () => setShow(false);
  const [addPaymentGet] = useAddPaymentGetMutation();

  const [getVal, setGetVal] = useState({
    paymentGat_client_id: Math.random(),
    paymentGat_method: "",
    paymentGat_client_secret: "",
    paymentGat_sendBox_mode: false
  })

  const onChengeHandle = (event) => {
    const clone = { ...getVal }
  ...
  const sendData = () => {
    const obj = { ...getVal, paymentGat_sendBox_mode: sendBox }
    console.log(obj);
    addPaymentGet(obj)
  }
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-sm-10">
                      <select
                        ...
                        name="paymentGat_method"
                      >
                        <option selected value={"Custom Payment"}>Custom Payment</option>
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-md-8">
                      ...
                      >
                        ...
                        <input type="file" value={getVal.file} name={"file"} placeholder="Choose File" onChange={onChengeHandle} />
  ...
  <div className="modal-dialog modal-adaptive" role="document"> */}
      ...
      <div className="modal-header pb-0 bg-light"> */}
                  ...
                  <div className="form-group row">
                      ...
                      <div className="note-editor note-frame card">
                        ...
                        <div className="note-editing-area">
                          ...
                          <div
                            ...
                            style={{ height: 200 }}
                          >
                            <p onChange={onChengeHandle} name="PaymentInstruction" value={getVal.PaymentInstruction}>
                              <br />
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="col-sm-10">
                      <input type="text" class="form-control" value={getVal.paymentGat_client_secret} onChange={onChengeHandle} placeholder="Payment Instruction" required fdprocessedid="6h7e8c" name="paymentGat_client_secret" />
                    </div>
                  ...
                  <div className="form-group row d-flex">
                    <label className="col-sm-2 col-from-label">
                      PaymentGat sendBox mode
                    </label>
                    <div class="form-check form-switch" style={{ width: "200px", paddingLeft: "50px" }}>
                      <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" onClick={() => { setSandBox(!sendBox) }} checked={sendBox} />
                    </div>

...
function ListCostCentreCategoryComp() {
    ...
    const deleteCostCentreData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/accountCostCenterType/delete_CostCenter/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                        ...
                        <form id="sort_support">
                            <div className="card-header row gutters-5">
                                <div className="col text-center text-md-left">
                                    <h5 className="mb-md-0 h6">Cost Centres Categories</h5>
                                </div>
                        ...
                        <div className="card-body">
                            ...
                            <table className="aiz-table footable footable-1 breakpoint-xl" cellSpacing={0} width="100%" style={{}}>
                                ...
                                <tbody>
                                    ...
                                    {loading ? <h3>Loading...</h3> : costCentreListData && costCentreListData.map((item, i) => {
                                        return <tr key={i}>
...
export default ListCostCentreCategoryComp
        ...
        <div className="aiz-side-nav-wrap list">
          ...
          >
                  ...
                  >
                    ...
                    <li className="aiz-side-nav-item">
                      ...
                      >
                        ...
                        <li className="aiz-side-nav-item">
                          <Link to="jewel-length" className="aiz-side-nav-link ">
                            <span className="labour-charge">Jewellery Length</span>
                          </Link>
                        </li>
                        <li className="aiz-side-nav-item">
                          <Link to="jewel-alphabet" className="aiz-side-nav-link ">
                            <span className="labour-charge">Alphabet</span>
                          </Link>
                        </li>
                        <li className="aiz-side-nav-item">
                          <Link to="curatedby" className="aiz-side-nav-link ">
                            <span className="labour-charge">Curated By</span>
                          </Link>
                        </li>
            ...
            <li className="aiz-side-nav-item">
              ...
              >
                <i className="las la-shopping-cart aiz-side-nav-icon" />
                <span className="aiz-side-nav-text">Influencer New</span>
                <span className="aiz-side-nav-arrow" />
              </Link>
              <ul
                className={`aiz-side-nav-list level-2 mm-collapse ${influencer ? "mm-show" : "extra"
                  }`}
                id="product"
              >
                <li className="aiz-side-nav-item">
          ...
          <div className="aiz-side-nav-wrap">
            ...
            >
              ...
              <li className="aiz-side-nav-item" id="dropdownList">
                ...
                <div className="dropdownMenu">
                  ...
                  >
                    ...
                    <li className="aiz-side-nav-item">
                      <Link to="products/all" className="aiz-side-nav-link">
                        <span className="aiz-side-nav-text">All Seller products</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="all/reviews" className="aiz-side-nav-link">
                        <span className="aiz-side-nav-text">
                          All Seller products Reviews
                        </span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="all/question" className="aiz-side-nav-link">
                        <span className="aiz-side-nav-text">All Seller Question</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link
                    ...
                    <li className="aiz-side-nav-item">
                      <Link to="categories" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Seller Category</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                    ...
                    <li className="aiz-side-nav-item">
                      <Link to="brands" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Seller Brands</span>
                      </Link>
                    </li>
                    ...
                    <li className="aiz-side-nav-item">
                      <Link to="attributes" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Seller Attribute</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="colors" className="aiz-side-nav-link ">
                    ...
                    <li className="aiz-side-nav-item">
                      <Link
                        ...
                        className="aiz-side-nav-link "
                      >
                        <span className="aiz-side-nav-text">Seller Set Attribute</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link
              ...
              <li className="aiz-side-nav-item">
                ...
                >
                  <i className="las la-shopping-cart aiz-side-nav-icon" />
                  <span className="aiz-side-nav-text">Order Management</span>
                  <span className="aiz-side-nav-arrow" />
                </Link>
                <ul
                  className={`aiz-side-nav-list level-2 mm-collapse ${orderMenu ? "mm-show" : "extra"
                    }`}
                >
                  <li className="aiz-side-nav-item">
                    <Link to="all_orders" className="aiz-side-nav-link ">
              ...
              <li className="aiz-side-nav-item">
                ...
                >
                  <i className="las la-link aiz-side-nav-icon" />
                  <span className="aiz-side-nav-text">Promotion Management</span>
                  <span className="aiz-side-nav-arrow" />
                </Link>
                <ul
                  className={`aiz-side-nav-list level-2 mm-collapse ${promotionManagement ? "mm-show" : "extra"
                    }`}
                >
                  <li className="aiz-side-nav-item">
                    <Link to="seller_packages" className="aiz-side-nav-link ">
            ...
            >
              ...
              <li className="aiz-side-nav-item">
                ...
                >
                  ...
                  <li className="aiz-side-nav-item">
                    <Link to="google-analytics-dashboard" className="aiz-side-nav-link ">
                      <span className="aiz-side-nav-text">Google Analytics Dashboad</span>
                    </Link>
                  </li>
                  <li className="aiz-side-nav-item">
                    <Link to="mgc-dashboard" className="aiz-side-nav-link ">
                      <span className="aiz-side-nav-text">MGC Dashboad</span>
                    </Link>
                  </li>
                  <li className="aiz-side-nav-item">
                    <Link
              ...
              <li className="aiz-side-nav-item">
                ...
                >
                  ...
                  <li className="aiz-side-nav-item">
                    <Link
                      to="cloudinary-credential"
                      className="aiz-side-nav-link"
                    >
                      <span className="aiz-side-nav-text">Cloudinary Credential</span>
                    </Link>
                  </li>
                </ul>
              </li>

              ...
              <ul className={`aiz-side-nav-list level-2 mm-collapse ${jwell ? "mm-show" : "extra"}`} id="product">
                ...
                <li className="aiz-side-nav-item">
                  ...
                  <ul style={{ marginLeft: "15px" }} className={`aiz-side-nav-list level-2 mm-collapse ${metal ? "mm-show" : "extra"}`} id="product">
                    ...
                    <li className="aiz-side-nav-item">
                      <Link to="metal-priceType" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Metal Price Type</span>
                      </Link>
                    </li>
                  </ul>
                </li>
                ...
                <li className="aiz-side-nav-item">
                  <Link to="#" className="aiz-side-nav-link " onClick={() => { setRateCard(!rateCard) }}>
                    <span className="aiz-side-nav-text">Rate Card</span>
                    <span className="aiz-side-nav-arrow" />
                  </Link>
                  <ul style={{ marginLeft: "15px" }} className={`aiz-side-nav-list level-2 mm-collapse ${rateCard ? "mm-show" : "extra"}`} id="product">
                    <li className="aiz-side-nav-item">
                      <li className="aiz-side-nav-item">
                        <Link to="metal-rate" className="aiz-side-nav-link ">
                          <span className="aiz-side-nav-text">Metal</span>
                        </Link>
                      </li>
                      <Link to="diamond-rate" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Diamond</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="colorStone-rate" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Color Stone</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="labourCharge-rate" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Labour Charge</span>
                      </Link>
                    </li>
                  </ul>
                </li>
                ...
                <li className="aiz-side-nav-item">
                  <Link to="#" className="aiz-side-nav-link " onClick={() => { setJwelleryProduct(!jwelleryProduct) }}>
                    <span className="aiz-side-nav-text">Jwellery Product Master</span>
                    <span className="aiz-side-nav-arrow" />
                  </Link>
                  <ul style={{ marginLeft: "15px" }} className={`aiz-side-nav-list level-2 mm-collapse ${jwelleryProduct ? "mm-show" : "extra"}`} id="product">

                    <li className="aiz-side-nav-item">
                      <Link to="add-jwellery-produt" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Add Jwellery Product</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="list-jwellery-products" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">List Jwellery Product</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="productWear-tag" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Product Wear Tag</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="productLook-tag" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Product Look Tag</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="product-tag" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Product Tag</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                      <Link to="size-jwells" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Jwells Size</span>
                      </Link>
                    </li>
                    <li className="aiz-side-nav-item">
                    ...
                    <li className="aiz-side-nav-item">
                      <Link to="add-collection" className="aiz-side-nav-link ">
                        <span className="aiz-side-nav-text">Add Collection</span>
                      </Link>
                    </li>
                ...
                <ul className={`aiz-side-nav-list level-2 mm-collapse ${celebrities ? "mm-show" : "extra"}`}>
                  ...
                  <li className="aiz-side-nav-item">
                    <Link to="list-general-celebrity" className="aiz-side-nav-link ">
                      <span className="aiz-side-nav-text">List Celebrities Type</span>
                    </Link>
                  </li>

                  <li className="aiz-side-nav-item">
                    <Link to="add-celebrity-category" className="aiz-side-nav-link ">
                      <span className="aiz-side-nav-text">Add Celebrity Category</span>
                    </Link>
                  </li>

                  <li className="aiz-side-nav-item">
                    <Link to="list-celebrity-category" className="aiz-side-nav-link ">
                      <span className="aiz-side-nav-text">List Celebrity Category</span>
                    </Link>
                  </li>

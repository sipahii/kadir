...
function CuratedByJewelComp() {
    ...
    const getdata = async () => {
        try {
            const res = await axios.get('https://onlineparttimejobs.in/api/curatedby', {
                headers: {
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/curatedBy/delete_curatedBy/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Curated By</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-curatedby" className="btn btn-circle btn-info">
                                    <span>Add Curated By</span>
                                </Link>
                            </div>
                        </div>
...
export default CuratedByJewelComp
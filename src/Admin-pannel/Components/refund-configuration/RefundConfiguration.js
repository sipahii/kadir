        ...
        <div className="px-15px px-lg-25px">
          <div className="row">
            <div className="col-lg-6">
              <div className="card">
                <div className="card-header">
                  <h5 className="mb-0 h6">Set Refund Time</h5>
                </div>
                <form className="form-horizontal" action="https://mmslfashions.in/admin/refund-request-time-store" method="POST" encType="multipart/form-data">
                  <input type="hidden" name="_token" defaultValue="OLa9ve64O5VmVO9NG77nNPSXl2TBhWxbo8WiyCvD" />                <div className="card-body">
                    <div className="form-group row">
                      <input type="hidden" name="type" defaultValue="refund_request_time" />
                      <label className="col-lg-4 col-from-label">Set Time for sending Refund Request</label>
                      <div className="col-lg-5">
                        <input type="number" min={0} step={1} defaultValue={3} placeholder name="value" className="form-control" />
                      </div>
                      <div className="col-lg-3">
                        <option className="form-control">days</option>
                      </div>
                    </div>
            ...
            <div className="col-lg-6">
              <div className="card">
                <div className="card-header">
                  <h6 className="mb-0 h6">Set Refund Sticker</h6>
                </div>
                <form className="form-horizontal" action="https://mmslfashions.in/admin/refund-request-sticker-store" method="POST" encType="multipart/form-data">
                  <input type="hidden" name="_token" defaultValue="OLa9ve64O5VmVO9NG77nNPSXl2TBhWxbo8WiyCvD" />                <div className="card-body">
                    <div className="form-group row">
                      <input type="hidden" name="type" defaultValue="refund_sticker" />
                      <label className="col-md-2 col-form-label" htmlFor="signinSrEmail">Sticker</label>
                      <div className="col-md-10">
                        <div className="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                          ...
                          <div className="form-control file-amount" defaultValue onClick={handleShow}>Choose File</div>
                ...
                <input type="hidden" name="type" value="refund_sticker">
                  <div class="form-group row">
                    <label class="col-lg-3 col-from-label" for="logo">Sticker</label>
                    <div class="col-lg-5">

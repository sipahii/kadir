...
function ListChiragFoundationCustomersComp() {
    ...
    const deleteData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                    ...
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">All Foundation Customers</h1>
                            </div>
                        </div>
                    </div>
                    <ToastContainer />
                    ...
                    <div className="card">
                        <form className id="sort_sellers" action method="GET">
                            ...
                            <div className="card-header row gutters-5">
                                ...
                                <div className="col">
                                    <h5 className="mb-md-0 h6">Foundation Customers</h5>
                                </div>
                                ...
                                >
                                    <thead>
                                        <tr className="footable-header">
                                            ...
                                            <th style={{ display: "table-cell" }}>Donated Amount</th>
                                            {/* <th
                                                data-breakpoints="lg"
                                                style={{ display: "table-cell" }}
                                            >
                                    ...
                                    <tbody>
                                        ...
                                        {listDonatedData ? listDonatedData.map((item, i) => {
                                            ...
                                            return <tr key={i}>
                                                ...
                                                <td style={{ display: "table-cell" }}>----</td> */}
                                                <td style={{ display: "table-cell" }}>{item?.phoneNumber}</td>
...
export default ListChiragFoundationCustomersComp;

  ...
  const getDetailCat = async () => {
    try {
      const res = await axios.get(
        `https://onlineparttimejobs.in/api/category/${params.id}`
      );
      setInputVal({
        name: res?.data?.name,
        parent_category: "",
                ...
                <div className="card-body">
                  <form className="form-horizontal" id="create-course-form">
                    <input
                      type="hidden"
                      name="_token"
                      defaultValue="JX7Efxc0fWnjgSTDtnGEP5Yd23Vk7icCfLqqxizf"
                    />
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-md-9">
                        <textarea
                          ...
                          rows={5}
                          className="form-control"
                          value={inputval?.meta_description}
                          onChange={onChangeHandler}
                        />
                      </div>
                    </div>
                    ...
                    <div className="form-group mb-0 text-right">
                      <button
                        type="button"
                        onClick={submitEditCategoryData}

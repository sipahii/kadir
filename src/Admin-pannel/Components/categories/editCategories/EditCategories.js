...
function EditCategories() {
  ...
  const submitEditCategoryData = async () => {
    ...
    fromData.append('name', inputval.name);
    // formData.append('image1', inputval.image1);
    fromData.append('image', inputval.image);
    fromData.append('meta_title', inputval.meta_title);
    fromData.append('meta_description', inputval.meta_description);
    fromData.append('parent_category', inputval.parent_category);
    fromData.append('commision_rate', inputval.commision_rate);
    fromData.append('order_level', inputval.order_level);

    try {
      const res = await axios.put(url, fromData,{
        headers: {

...
import { cone } from './AssetCategorey'
...
function AssetAddCategory() {
    ...
    const toastSuccessMessage = () => {
        toast.success("Assets category added Successfully.", {
            position: "top-center"
        })
    };
    ...
    const postData = async () => {
        const postApi = await axios.post(`${base_Url_Assets}assetCategories/add_assetCategoriess`, addAsset)
        // console.log(postApi)
        setAddAssets({
            name: '',
            description: '',

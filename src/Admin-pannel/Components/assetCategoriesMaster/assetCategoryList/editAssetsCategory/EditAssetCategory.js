...
function EditAssetCategory() {
    ...
    const getAssetId = async () => {
        const getByIdData = await axios.get(`${base_Url_Assets}assetCategories/${params.id}`)
    ...
    const editHandle = async () => {
        const responce = await axios.put(`${base_Url_Assets}assetCategories/update_assetCategoriess/${params.id}`,addAsset)

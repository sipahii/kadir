...
function AssetsList() {
    ...
    const getApiData = async () => {
        setLoading(true)
        const res = await axios.get(`${base_Url_Assets}asset`,
            {
                headers: {
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Asset List</h5>
                            <div className="col-md-6 text-md-right">
                                    ...
                                    {loading ? <h2>Loading...</h2> :
                                        get && get?.map((item, i) => {
                                            return <tr key={i}>
                                                ...
                                                <td><img width={'100px'} src={item?.image?.url} alt="" /></td>

            ...
            <div className="row">
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">View All Flash Deals</label>
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Add Flash Deal</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Edit Flash Deal</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Delete Flash Deal</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Publish Flash Deal</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Featured Flash Deal</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">View All Coupons</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Add Coupon</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Edit Coupon</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Delete Coupon</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Send Newsletter</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">View All Subscribers</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Delete Subscriber</label>
                  <label className="aiz-switch aiz-switch-success">

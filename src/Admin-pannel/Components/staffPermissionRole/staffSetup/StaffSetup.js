    ...
    <>
      <div className="bd-example">
        <ul className="list-group">
          <li className="list-group-item bg-light" aria-current="true">Setup Configurations</li>
          <li className="list-group-item">
            <div className="row">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Features activation</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Language Setup</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Currency Setup</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Vat &amp; Tax Setup</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Pickup Point Setup</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Payment Methods Configurations</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Order Configuration</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">File System &amp; Cache Configuration</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Social media Logins</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Facebook Chat</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Facebook Comment</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Analytics Tools Configuration</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Google Recaptcha Configuration</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Google Map Setting</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Google Firebase Setting</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Shipping Configuration</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Shipping Country Setting</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Manage Shipping States</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Manage Shipping Cities</label>
                  <label className="aiz-switch aiz-switch-success">
              ...
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Manage Zones</label>
                  <label className="aiz-switch aiz-switch-success">
                    <input type="checkbox" name="permissions[]" className="form-control demo-sw" defaultValue={210} />
                    <span className="slider round" />
                  </label>
                </div>
              </div>
              <div className="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <div className="p-2 border mt-1 mb-2">
                  <label className="control-label d-flex">Manage Carriers</label>
                  <label className="aiz-switch aiz-switch-success">
                    <input type="checkbox" name="permissions[]" className="form-control demo-sw" defaultValue={211} />
                    <span className="slider round" />
                  </label>
                </div>
              </div>

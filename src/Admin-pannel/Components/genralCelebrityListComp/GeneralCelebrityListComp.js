...
function GeneralCelebrityListComp() {
    ...
    const deleteData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/sellerList/delete_sellers/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                    ...
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Group Celebrities</h1>
                            </div>
                        </div>
                    </div>
                    <ToastContainer />
...
export default GeneralCelebrityListComp;

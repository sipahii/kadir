...
function ListCollectionManagementComp() {
    ...
    const toastErrorMessage = () => {
        toast.error("Collection Not Deleted ", {
            position: "top-center"
        })
    };
    ...
    const deletData = async (id) => {
        setLoading(true)
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/collection/delete_collection/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        {/* <div className="card-header">
                            <h5 className="mb-0 h6">Style</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-collection" className="btn btn-circle btn-info">
                        ...
                        <div className="card-header custom-card-header" id="custome-cardHeader">
                            <div className="row">
                                <div className="col-lg-6">
                                    <h5 className="mb-0 h6">Collection</h5>
                                </div>
                                ...
                                <div className="col-lg-2 text-md-right">
                                    <Link to="/admin/add-collection" className="btn btn-info">
                                        <span>Add Collection</span>
                                    </Link>
                                </div>
                            </div>
...
export default ListCollectionManagementComp
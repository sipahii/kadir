...
function LengthJewelComp() {
    ...
    const getdata = async () => {
        try {
            const res = await axios.get('https://onlineparttimejobs.in/api/length', {
                headers: {
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/length/delete_length/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Jewellery Length</h1>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Jewellery Length </h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-jewel-length" className="btn btn-circle btn-info">
                                    <span>Add Jewellery Length</span>
                                </Link>
                            </div>
                        </div>
...
export default LengthJewelComp
    ...
    <div className="card">
      ...
      <div className="card-body">
        <form id="create-course-form" className="form-horizontal">
          ...
          <div className="form-group row">
            ...
            <div className="col-md-9">
              ...
              >
                ...
                {categoryD &&
                  categoryD.map((item, i) => {
                    return (
                      <option value={item?.uid} key={i}>
                        {item?.name}
                      </option>
                    );
                  })}
              ...
              <div className="input-group" data-type="image">
                ...
                <div className="form-control file-amount">
                  <input
                    ...
                    onChange={(e) => {
                      onChangeThumbnailImage(e, item.language_id);
                    }}
                  />
                </div>
              </div>
              ...
              >
                ...
                <div className="form-control file-amount">
                  <input
                    ...
                    className="selected-files"
                    onChange={(e) => {
                      onChangeHandler(e, item.language_id, "meta");
                    }}
                  />
                </div>
              </div>
          ...
          <div className="form-group row">
            <label className="col-md-3 col-form-label">Meta Keywords</label>
            <div className="col-md-9">
              <input
                type="text"
                className="form-control"
          ...
          <div className="form-group row">
            <label className="col-md-3 col-form-label">Vide Url</label>
            <div className="col-md-9">
              <input
                type="text"
                className="form-control"

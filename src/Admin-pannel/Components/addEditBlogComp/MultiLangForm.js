...
function MultiLangForm({ data, item, i, params, sendData, onChangeHandler, setValue, onChangeThumbnailImage, showImageD, setShowImageD, onChangeHandleExcel }) {
                    ...
                    <div className="col-md-9">
                        <div className="input-group" data-type="image">
                            ...
                            <div className="form-control file-amount">
                                <input type="file" name="banner" className="selected-files" onChange={(e) => { onChangeThumbnailImage(e, item.language_id) }} />
                            </div>
                        </div>

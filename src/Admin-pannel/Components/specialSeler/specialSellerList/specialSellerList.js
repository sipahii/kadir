...
function SpecialSellerList() {
  ...
  const filterPaginationCounts = async (clone) => {
    try {
      const resp = await axios.post(`${base_Url}specialSeller/filterCount`, clone, {
        withCredentials: true,
        headers: {
          "Content-type": "application/json; charset=UTF-8",
          Authorization: `Bearer ${token}`,
  ...
  const postSearchList = async (abcPage) => {
    ...
    setspinn(true)
    const clone = {
      ...searchList, income: finalCatD, disability: +searchList.disability, Division: finalCatD2, District: finalCatD3, page: abcPage,
      count: 10, disType: finalDisabilityTypeD
    }
  ...
  useEffect(() => {
    if (params?.id) {
      ...
      const getParam = async () => {
        setapedFilter(true)
        setspinn(true)
        const clone = { ...searchList, income: finalCatD, disability: +searchList.disability, Division: finalCatD2, District: finalCatD3, status: params.id, disType: finalDisabilityTypeD }
        try {
          const res = await axios.post(`${base_Url}specialSeller/filter`, clone, {
            withCredentials: true,
            headers: {
  ...
  const handleLoadTotalBeneficiaries = async () => {
    ...
    try {
      if (excelDownloadDataAcc) {
        ...
        setLoader(true)
        const res = await axios.post(`${base_Url}specialSeller/allFilter`, clone, {
          withCredentials: true,
          headers: {
            "Content-type": "application/json; charset=UTF-8",
            Authorization: `Bearer ${token}`,
  ...
  async function toDataURL(url, na) {
    ...
    if (url != undefined && url != null && url?.slice(-3) == "pdf") {
      url = "https://stagingapi.mshfdc.co.in/api/cloudinaryimage/pdf2image/" + url?.slice(49)
                              ...
                              <div class="Gender" style="display:flex; justify-content:space-around">
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].gender == "Male" ? "checked" : ""}
                                   />
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].gender == "Female" ? "checked" : ""}
                                   />
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].gender == "Trans" ? "checked" : ""}
                                   />
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].gender == "Other" ? "checked" : ""}
                                   />
                                  <label
                                    class="form-check-label"
                              ...
                              <div class="Blood-Group" style="display:flex; justify-content:space-around">
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].bloodGroup == "O+" ? "checked" : ""}
                                  />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].bloodGroup == "A+" ? "checked" : ""}
                                   />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].bloodGroup == "B+" ? "checked" : ""}
                                  />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].bloodGroup == "AB+" ? "checked" : ""}/>
                                  <label
                                    class="form-check-label"
                              ...
                              <div class="Category-1" style="display:flex; flex-wrap:wrap; justify-content:space-around">
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    type="radio"
                                    name="castCategory"
                                    ${listProfe[0].castCategory == "General" ? "checked" : ""}
                                   />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "OBC" ? "checked" : ""} 
                                   />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "SC" ? "checked" : ""}
                                    />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "ST" ? "checked" : ""}
                                    />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "VJNT" ? "checked" : ""}
                                  />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "NT-B" ? "checked" : ""}
                                  />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "NT-C" ? "checked" : ""}
                                  />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "NT-D" ? "checked" : ""}
                                  />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].castCategory == "SBC" ? "checked" : ""}
                                  />
                                  <label
                                    class="form-check-label"
                                    htmlFor="flexRadioDefault22"
                              ...
                              <div class="Marital-Status" style="display:flex; justify-content:space-around">
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    type="radio"
                                    name="maritalStatus"
                                    ${listProfe[0].maritalStatus == "Married" ? "checked" : ""}/>
                                    <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    type="radio"
                                    name="maritalStatus"
                                    ${listProfe[0].maritalStatus == "Unmarried" ? "checked" : ""}
                                    />
                                    <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    type="radio"
                                    name="maritalStatus"
                                    ${listProfe[0].maritalStatus == "Widow" ? "checked" : ""}
                                    />
                                    <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    type="radio"
                                    name="maritalStatus"
                                    ${listProfe[0].maritalStatus == "Divorced" ? "checked" : ""}/>
                                    <label
                                    class="form-check-label"
                              ...
                              <div class="Relationship" style="display:flex; justify-content:space-around">
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    ${listProfe[0].relatedToGuardian == "Father" ? "checked" : ""}
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    name="relatedToGuardian"
                                    ${listProfe[0].relatedToGuardian == "Mother" ? "checked" : ""}
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    name="relatedToGuardian"
                                    value="Wife"
                                    ${listProfe[0].relatedToGuardian == "Wife" ? "checked" : ""}
                                   />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    name="relatedToGuardian"
                                    ${listProfe[0].relatedToGuardian == "Husband" ? "checked" : ""}
                                   />
                                  <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    name="relatedToGuardian"
                                    value="Other"
                                    ${listProfe[0].relatedToGuardian == "Other" ? "checked" : ""} 
                                    }
                                   />
                              ...
                              <div class="d-flex">
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    name="residentOf"
                                    ${listProfe[0].residentOf == "Yes" ? "checked" : ""}/>
                                    <label
                                    class="form-check-label"
                                ...
                                <div class="form-check mr-2">
                                  <input
                                    ...
                                    name="residentOf"
                                    ${listProfe[0].residentOf == "No" ? "checked" : ""}
                                    />
                                    <label
                                    class="form-check-label"
        ...
        <div className="px-15px px-lg-25px">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <section className="form-section">
                <div className="row">
                  ...
                  <div className="col-lg-3 mt-3">
                    <button type="button" className="btn btn-primary mr-3 mt-2" onClick={() => postSearchList(0)}>Search</button>
              ...
              <button type="button" className="btn btn-primary mr-3 mt-2" onClick={handleLoadTotalBeneficiaries}>Prepare Beneficiary Excel Sheet</button>

              {showDownloadExcelBtn && <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <tbody>
                    {listSeller && listSeller?.map((item, i) => {
                      ...
                      return <tr key={item._id} className="table-to-xls">
                        ...
                        <td>{new Date(item?.seller?.applicationDate).getDate() + "/" + (new Date(item?.seller?.applicationDate).getMonth() + 1) + "/" + new Date(item?.seller?.applicationDate).getFullYear()}</td>
                        <td>{item?.seller?.bene_firstname}</td>
                        <td>{item?.seller?.bene_lastname}</td>
                        {/* <td>{item?.seller?.dob}</td> */}
                        <td>{new Date(item?.seller?.dob).getDate() + "/" + (new Date(item?.seller?.dob).getMonth() + 1) + "/" + new Date(item?.seller?.dob).getFullYear()}</td>
              ...
              <div className="" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', margin: '5px 10px' }}>
                {pagesCount && <Pagination onChange={onChangeVal} total={totalCount} showQuickJumper />}
                <h5 style={{ marginTop: '10px' }}>Total Beneficiaries: <span style={{ color: 'green' }}>{totalCount}</span></h5>
              </div>
                  ...
                  <div className="col-md-12">
                    <ul type="disc " style={{ listStyle: "unset" }}>
                      ...
                      <li className="mt-3">
                        ...
                        <div className="">
                          <input type="text" className="pl-2" name="spouse_name" value={pdfData?.seller.spouse_name} style={{ width: '600px' }} />
                        </div>
                      </li>
                  ...
                  <div className="col-md-6">
                    <ul style={{ listStyle: "unset" }}>
                      ...
                      <li className="">
                        ...
                        <div className="d-flex" >
                          <input type="text" className="pl-1" value={pdfData?.seller?.guardian_name} style={{ width: '600px' }} />
                        </div>
                    ...
                    <ul style={{ listStyle: "unset" }}>F
                      ...
                      <li className="">
                        ...
                        <div className="d-flex" style={{ width: '500px' }}>
                          <input type="number" className="pl-1" value={pdfData?.seller?.guardian_contact} placeholder="+91" />
                        </div>
            ...
            <div style={{ display: 'none' }}>
              <div className="mainsel" style={{ overflow: "auto" }}>
                <table className="table table-3" id="table-to-xlsx">
                  ...
                  <tbody>
                    {excelDownloadAllData && excelDownloadAllData?.map((item, i) => {
                      return <tr key={item._id} className="table-to-xls">
                        <td>{i + 1}</td>
                        <td style={{ display: 'table-cell' }}>
                          <span class="badge badge-inline badge-danger" style={{ color: "black", fontSize: '14px', fontWeight: 'bold', backgroundColor: item?.status[0]?.name === "Rejected" ? "red" : item?.status[0]?.name === 'Pending' ? 'yellow' : item?.status[0]?.name === 'Approved' ? 'green' : item?.status[0]?.name === 'Waiting' ? 'blue' : item?.status[0]?.name === 'Next Slot' ? 'purple' : '' }}>{item?.status[0]?.name}</span>

                ...
                <div className='row'>
                    <div className='col-lg-4'>
                        <div className='card'>
                            <div className="card-header row gutters-5">
                                <div className="col text-center text-md-left">
                                    <h5 className="mb-md-0 h6">Top Venture/Company Revenue wise</h5>
                                </div>
                            </div>
                            <div className="card-body">
                                <div style={{ display: 'flex', borderRadius: '5px', boxShadow: '0 0 6px gray' }}>
                                    <div className='img-log' style={{ height: '60px', width: '25%', borderRight: '1px solid gray', borderRadius: '5px 0 0 5px' }}>
                                        <img src='' alt='company-logo' />
                                    </div>
                                    <div style={{ height: '60px', width: '75%', borderRadius: '0 5px 5px 0', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '8px' }}>
                                        <h6 style={{ margin: '0', fontWeight: 'bold' }}>Mar'x Entertainment</h6>
                                        <p>Revenue: $489</p>
                                    </div>
                                </div>
                    ...
                    <div className='col-lg-4'>
                        <div className='card'>
                            <div className="card-header row gutters-5">
                                <div className="col text-center text-md-left">
                                    <h5 className="mb-md-0 h6">Top Venture/Company User wise</h5>
                                </div>
                            </div>
                            <div className="card-body">
                                <div style={{ display: 'flex', borderRadius: '5px', boxShadow: '0 0 6px gray' }}>
                    ...
                    <div className='col-lg-4'>
                        <div className='card'>
                            <div className="card-header row gutters-5">
                                <div className="col text-center text-md-left">
                                    <h5 className="mb-md-0 h6">Top 10 Services</h5>
                                </div>
                            </div>
                            <div className="card-body">
                                <div style={{ display: 'flex', borderRadius: '5px', boxShadow: '0 0 6px gray' }}>
                                    ...
                                    <div style={{ height: '60px', width: '75%', borderRadius: '0 5px 5px 0', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '8px' }}>
                                        <h6 style={{ margin: '0', fontWeight: 'bold' }}>Indian Models</h6>
                                        <p>Models: 7893</p>
                                    </div>
                                </div>

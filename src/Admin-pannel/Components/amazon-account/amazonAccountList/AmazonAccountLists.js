        ...
        <div className="aiz-titlebar text-left mt-2 mb-3">
          <div className="row align-items-center">
            <div className="col-md-6">
              <h1 className="h3">Amazon Account List</h1>
            </div>
          </div>
        </div>
        <div className="card">
          <div className="card-header">
            <h5 className="mb-0 h6">Amazon Account List</h5>
            <div className="col-md-6 text-md-right">
              <Link
                className="btn btn-circle btn-info"
                to="/admin/amazon-account-info/add-amazon-account"
              >
                <span>Add Amazon Seller Account</span>
              </Link>
            </div>
          </div>
...
export default AmazonAccountLists;

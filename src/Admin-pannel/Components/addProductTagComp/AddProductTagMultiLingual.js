...
function AddProductTagMultiLingual({ data, item, i, params, sendData, onChangeHandler, setValue }) {
    return (
        <>
                    ...
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">{params?.uid ? 'Update' : 'Add'} Product Tag</h1>
                            </div>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">{params?.uid ? 'Update' : 'Add'} Product Tag({item.lable})</h5>
                        </div>
                        <div className="card-body">
                            ...
                            <section className="form-section">
                                <div className="row">
                                    ...
                                    <div className="col-lg-4">
                                        <div>
                                            <input type="text" name="color" value={item.color} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Color*" onChange={(e) => { onChangeHandler(e, item.language_id) }} />
                                        </div>
                                    </div>
...
export default AddProductTagMultiLingual
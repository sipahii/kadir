...
function ProductLookTagComp() {
    ...
    const getdata = async () => {
        setLoading(true)
        try {
            const res = await axios.get('https://onlineparttimejobs.in/api/lookTag', {
                headers: {
    ...
    const toastSuccessMessage = () => {
        toast.success("Product Look tag Deleted", {
            position: "top-center"
        })
    };
    const toastErrorMessage = () => {
        toast.error("Product Look tag Not Deleted ", {
            position: "top-center"
        })
    };
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/lookTag/delete_lookTag/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Product Look Tag</h1>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Product Look Tag</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-productLook-tag" className="btn btn-info">
                                    <span>+ Add Product Look Tag</span>
                                </Link>
                            </div>
                        </div>
...
export default ProductLookTagComp
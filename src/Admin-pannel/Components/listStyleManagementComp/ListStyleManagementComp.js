...
function ListStyleManagementComp() {
    ...
    const deletData = async (id) => {
        setLoading(true)
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/style/delete_style/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        {/* <div className="card-header">
                            ...
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-style" className="btn btn-circle btn-info">
                                    <span>Add Style</span>
                                </Link>
                            </div>
                        </div> */}
                        ...
                        <div className="card-header custom-card-header" id="custome-cardHeader">
                            <div className="row">
                                ...
                                <div className="col-lg-2 text-md-right">
                                    <Link to="/admin/add-style" className="btn btn-info">
                                        <span>Add Style</span>
                                    </Link>
                                </div>
                            </div>
...
export default ListStyleManagementComp
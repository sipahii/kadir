                    ...
                    <table className="table table-3 position-relative">
                        ...
                        <tbody>
                            {get && get?.map((item) => {
                                ...
                                <td>
                                    <Link className="btn btn-primary btn-icon btn-circle btn-sm me-2 btn-circle-2" title="View" to={`/admin/department/edit/${item?._id}`}>
                                    ...
                                    <Link className="ms-2 btn btn-primary btn-icon btn-circle btn-sm me-2 btn-circle-2" title="View" to={`/admin/view-department/details/${item?._id}`}>
                                        {/* <i className="las la-eye">
                                    </i> */}
                                        <GrView />
                                    </Link>

...
function MetalPriceTypeComp() {
    ...
    const toastSuccessMessage = () => {
        toast.success("Metal Price Type Deleted", {
            position: "top-center"
        })
    };
    const toastErrorMessage = () => {
        toast.error("Metal Price Type Not Deleted ", {
            position: "top-center"
        })
    };
    ...
    const deletData = async (id) => {
        setLoading(true)
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/priceType/delete_priceType/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    {/* <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Metal Price Type</h1>
                            </div>
                    ...
                    <div className="card">
                        ...
                        {/* <div className="card-header">
                            <h5 className="mb-0 h6">Metal Price Type</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-metal-priceType" className="btn btn-circle btn-info">
                                    <span>Add Metal Price Type</span>
                                </Link>
                            </div>
                        </div> */}
                        ...
                        <div className="card-header custom-card-header" id="custome-cardHeader">
                            <div className="row">
                                ...
                                <div className="col-lg-2 text-md-right">
                                    <Link to="/admin/add-metal-priceType" className="btn btn-info">
                                        <span>Add Metal Price Type</span>
                                    </Link>
                                </div>
                            </div>
...
export default MetalPriceTypeComp
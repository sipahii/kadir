...
function MetalTypeComp() {
    ...
    const toastSuccessMessage = () => {
        toast.success("Metal Type Deleted", {
            position: "top-center"
        })
    };
    const toastErrorMessage = () => {
        toast.error("Metal Type Not Deleted ", {
            position: "top-center"
        })
    };
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/metalType/delete_metalType/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        ...
                        {/* <div className="card-header">
                            <h5 className="mb-0 h6">Metal Type</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-metal-type" className="btn btn-circle btn-info">
                                    <span>Add Metal Type</span>
                                </Link>
                            </div>
                        </div> */}
                        ...
                        <div className="card-header custom-card-header" id="custome-cardHeader">
                            <div className="row">
                                ...
                                <div className="col-lg-2 text-md-right">
                                    <Link to="/admin/add-metal-type" className="btn btn-info">
                                        <span>Add Metal Type</span>
                                    </Link>
                                </div>
                            </div>

...
function ListDiamondQuality() {
    ...
    const deletData = async (id) => {
        setLoading(true)
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/quality/delete_quality/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    <div className="card">
                        ...
                        {/* <div className="card-header">
                            <h5 className="mb-0 h6">Diamond Quality</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-diamond-quality" className="btn btn-circle btn-info">
                        ...
                        <div className="card-header custom-card-header" id="custome-cardHeader">
                            <div className="row">
                                ...
                                <div className="col-lg-2 text-md-right">
                                    <Link to="/admin/add-diamond-quality" className="btn btn-info">
                                        <span>Add Diamond Quality</span>
                                    </Link>
                                </div>
                            </div>

...
function AddDiamondQualityMultiLingual({ data, params, item, i, sendData, onChangeHandler, setValue, onChangeThumbnailImage, showImageD, setShowImageD }) {
                            ...
                            <section className="form-section">
                                <div className="row">
                                    ...
                                    <div className="col-lg-4 mt-3">
                                        ...
                                        <textarea id="w3review" className="form-control" name="meta_description" value={item?.meta_description} placeholder='Description' rows={3} cols={''} onChange={(e) => { onChangeHandler(e, item.language_id) }} />
                                    </div>
                                    ...
                                    <div className="col-lg-12 mt-5" style={{ display: 'flex', justifyContent: 'end' }}>

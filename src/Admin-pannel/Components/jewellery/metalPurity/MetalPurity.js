...
function MetalPurity() {
    ...
    const getdata = async () => {
        setLoading(true)
        try {
            const res = await axios.get('https://onlineparttimejobs.in/api/purity', {
                headers: {
    ...
    const toastSuccessMessage = () => {
        toast.success("Metal Purity Deleted", {
            position: "top-center"
        })
    };
    const toastErrorMessage = () => {
        toast.error("Metal Purity Not Deleted ", {
            position: "top-center"
        })
    };
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/purity/delete_purity/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Metal Purity</h1>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Metal Purity</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-metal-purity" className="btn btn-circle btn-info">

...
function AssestsRequestList() {
    ...
    const getApiData = async () => {
        setLoading(true)
        const res = await axios.get(`${base_Url_Assets}assetIssueTransaction`,
            {
                headers: {
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Assests Request List</h1>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Request List</h5>
                            {/* <div className="col-md-6 text-md-right">
                            ...
                            <table className="table table-3 position-relative">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-secondary" scope="col">Requester Name</th>
                                    ...
                                    {loading ? <h2>Loading...</h2> :
                                        get && get?.map((item, i) => {
                                            return <tr key={i}>
                                                ...
                                                <td>
                                                    {item?.assignType == 'Seller' ? item?.seller_id?.firstname + " " + item?.seller_id?.lastname : item?.assignType == 'Staff' ? item?.staff_id?.firstname + " " + item?.staff_id?.lastname : null}
                                                </td>
                                                <td>
...
export default AssestsRequestList;
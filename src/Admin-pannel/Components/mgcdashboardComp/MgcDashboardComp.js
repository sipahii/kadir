    ...
    return (
        <>
            <div className='container' style={{ marginLeft: 60, marginRight: 60 }}>
                <div className='d-flex' style={{ display: 'flex', justifyContent: 'space-around' }}>
                    <div className='bg-white col-md-2 m-0 pl-2  border-secondary mr-3' style={{ width: '90', height: 130 }}>
                        <div className=" m-0 p-0 ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>Total Revenue</h6>
                    ...
                    <div className='bg-white col-md-2 m-0 pl-2  border-secondary mr-3' style={{ width: '90', height: 130 }}>
                        <div className=" m-0 p-0 ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>No Of Sales</h6>
                            <div className='justify-content-center d-flex'>
                                <h3>38.53%</h3>
                            </div>
                            <div className='ml-1'>
                    ...
                    <div className='card col-md-2 m-0 pl-2 mr-3' style={{ width: '90', height: 130 }}>
                        <div className="  ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>No Of Bookings</h6>
                            <div className='justify-content-center d-flex'>
                                <h3>8.56</h3>
                            </div>
                            <div className='ml-1'>
                    ...
                    <div className='card col-md-2 m-0 pl-2 mr-3' style={{ width: '90', height: 130 }}>
                        <div className="  ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>Cancelled Bookings</h6>
                            <div className='justify-content-center d-flex'>
                                <h3>00:10:19</h3>
                            </div>
                            <div className='ml-1'>
                ...
                <div className='d-flex mt-3' style={{ display: 'flex', justifyContent: 'space-around' }}>
                    <div className='card col-md-2 m-0 pl-2 mr-3' style={{ width: '90', height: 130 }}>
                        <div className="  ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>Total Payments</h6>
                            <div className='justify-content-center d-flex'>
                                <h3>8.56</h3>
                            </div>
                            <div className='ml-1'>
                    ...
                    <div className='bg-white col-md-2 m-0 pl-2  border-secondary mr-3' style={{ width: '90', height: 130 }}>
                        <div className=" m-0 p-0 ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>Pending Payments</h6>
                            <div className='justify-content-center d-flex'>
                                <h3>89.2B</h3>
                            </div>
                            <div className='ml-1'>
                    ...
                    <div className='bg-white col-md-2 m-0 pl-2  border-secondary mr-3' style={{ width: '90', height: 130 }}>
                        <div className=" m-0 p-0 ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>Paid Payments</h6>
                            <div className='justify-content-center d-flex'>
                                <h3>38.53%</h3>
                            </div>
                            <div className='ml-1'>
                    ...
                    <div className='card col-md-2 m-0 pl-2 mr-3' style={{ width: '90', height: 130 }}>
                        <div className="  ">
                            <h6 className='fs-5 mt-2 ml-1 ' style={{ color: '#525252' }}>Total Users</h6>
                            <div className='justify-content-center d-flex'>
                                <h3>00:10:19</h3>
                            </div>
                            <div className='ml-1'>
                ...
                <div className='row ' style={{ marginTop: 30, marginRight: 60 }} >
                    <div className='col-md-12 '>
                        <h5 className='m-0 p-0' style={{ color: '#006666' }}>Country Wise Revenue</h5>
            ...
            <div className='col-md-12 '>
                ...
                <div className='row' style={{ marginTop: 30, marginRight: 60 }}>
                    <div className='col-md-6'>
                        <h4 className='m-0 p-0' style={{ color: '#006666' }}>Top 10 Packages</h4>
                        <hr className=' border-primary  m-auto mt-2' />
                        <Table striped className='mt-3 border-light m-0 p-0'>
                            <thead className='m-0 p-0' >
                                <tr>
                    ...
                    <div className='col-md-6'>
                        <h4 className='m-0 p-0' style={{ color: '#006666' }}>Top 10 Services</h4>
                        <hr className=' border-primary m-auto mt-2' />
                        <Table striped className='mt-3 border-light m-0 p-0'>
                            <thead className='m-0 p-0' >
                                <tr>
                ...
                <div className='row' style={{ marginTop: 30, marginRight: 60 }}>
                    <div className='col-md-6'>
                        <h4 className='m-0 p-0' style={{ color: '#006666' }}>Top 10 Influencers</h4>
                        <hr className=' border-primary  m-auto mt-2' />
                        <Table striped className='mt-3 border-light m-0 p-0'>
                            <thead className='m-0 p-0' >
                                <tr>
                    ...
                    <div className='col-md-6'>
                        <h4 className='m-0 p-0' style={{ color: '#006666' }}>Top 10 Customers</h4>
                        <hr className=' border-primary m-auto mt-2' />
                        <Table striped className='mt-3 border-light m-0 p-0'>
                            <thead className='m-0 p-0' >
                                <tr>
...
export default MgcDashboardComp
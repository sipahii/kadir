...
function ListGemstoneComp() {
    ...
    const getdata = async () => {
        setLoading(true)
        try {
            const res = await axios.get('https://onlineparttimejobs.in/api/gemStone', {
                headers: {
    ...
    const toastErrorMessage = () => {
        toast.error("Gemstone Not Deleted ", {
            position: "top-center"
        })
    };
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/gemstone/delete_gemstone/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Gemstone</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-gemstone" className="btn btn-circle btn-info">
...
export default ListGemstoneComp
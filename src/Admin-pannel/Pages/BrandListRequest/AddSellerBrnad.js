...
function AddSellerBrnad() {
    ...
    const addNewBrandData = async (e) => {
        ...
        fromData.append('brand_name', clonedObj.name);
        fromData.append('logo', file);
        fromData.append('attachments', proof);
        fromData.append('meta_title', clonedObj.meta_title);
        fromData.append('meta_description', clonedObj.meta_description);
        fromData.append('seller_id',  selerId);

...
function AddNewDeliveryBoy() {
    ...
    const submitStaffData = async (e) => {
        ...
        if (isPickupManagerLogin === 'true') {
            fromData.append('firstname', inputVal.firstname);
            fromData.append('lastname', inputVal.lastname);
            fromData.append('email', inputVal.email);
            fromData.append('mobile', inputVal.mobile);
            fromData.append('state', inputVal.state);
            fromData.append('country', inputVal.country);
            fromData.append('city', inputVal.city);
            fromData.append('pickupPoint', isPickupManagerId);
            fromData.append('province', inputVal.province);
            fromData.append('pin', inputVal.pin);
            fromData.append('province', inputVal.province);
            fromData.append('pin', inputVal.pin);
            fromData.append('password', inputVal.password);
            // fromData.append('language_id', inputVal.language_id);
            // fromData.append('currency_id', inputVal.currency_id);
            ...
            fromData.append('country', inputVal.country);
            fromData.append('city', inputVal.city);
            fromData.append('pickupPoint', pickupId);
            fromData.append('province', inputVal.province);
            fromData.append('pin', inputVal.pin);
            // fromData.append('language_id', inputVal.language_id);
            // fromData.append('currency_id', inputVal.currency_id);
        ...
        try {
            const res = await axios.post(`https://onlineparttimejobs.in/api/deliveryBoy/add_deliveryBoy`, fromData, {
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
                    'Authorization': 'Bearer ' + token
                },

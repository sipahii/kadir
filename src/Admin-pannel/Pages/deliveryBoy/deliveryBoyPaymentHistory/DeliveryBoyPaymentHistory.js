...
function DeliveryBoyPaymentHistory() {
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">All Payment List</h1>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Payment List</h5>
                        </div>
                                ...
                                : <table className="table aiz-table footable footable-1 breakpoint-lg" style={{}}>
                                    <thead>
                                        <tr className="footable-header">
                                            ...
                                            <th style={{ display: 'table-cell' }}>Payment Amount</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
export default DeliveryBoyPaymentHistory
...
function PickupProfile() {
    ...
    const updateDetail = async () => {
        ...
        fromData.append('firstname', state.firstname);
        fromData.append('lastname', state.lastname);
        fromData.append('email', state.email);
        fromData.append('mobile', state.mobile);
        fromData.append('image', file);

        try {
            const res = await axios.put(`https://onlineparttimejobs.in/api/staff/update_Staff/${pickupid}`, fromData)
            setissusses(true)

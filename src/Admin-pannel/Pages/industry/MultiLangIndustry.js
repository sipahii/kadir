...
import { useGetCategoriesQuery, useGetIndustryQuery } from '../../Components/all-products/allproductsApi/allProductsApi';
...
function MultiLangIndustry({ data, item, i, addNewAttributeData, onChangeHandler, setValue, onChangeHandlesr }) {
    ...
    return <div className="card">
        <div className="card-header">
            <h5 className="mb-0 h6">Industry Information ({item?.lable})</h5>
        </div>
...
export default MultiLangIndustry
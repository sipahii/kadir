...
function IndustryMaster() {
  ...
  const toastErrorMessage = () => {
    toast.error("Industry Update Faild..", {
      position: "top-center"
    })
  };
        ...
        <div className="px-15px px-lg-25px">
          ...
          <div className="card">
            ...
            <div className="card-header d-block d-md-flex">
              <h5 className="mb-0 h6">Industry</h5>
                    ...
                    {blankArr && blankArr.map((item, i) => {
                      return <tr key={item._id}>
                        ...
                        <td className="text-right footable-last-visible" style={{ display: 'table-cell' }}>
                          <Link to={`/admin/industry/create_industryMaster/edit/${item.uid}`} className="btn btn-soft-primary btn-icon btn-circle btn-sm" title="Edit">

...
import { useBrandActiveMutation, useDeleteBrandMutation, useGetBrandsQuery } from "../../../Components/all-products/allproductsApi/allProductsApi";
                ...
                <div className="card">
                    <div className="card-header row gutters-5">
                        <div className="col text-center text-md-left">
                            <h5 className="mb-md-0 h6">List Policy</h5>
                        </div>
                        <ToastContainer />

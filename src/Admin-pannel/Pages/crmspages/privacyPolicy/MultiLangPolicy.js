...
function MultiLangPolicy({ data, item, i, addNewAttributeData, onChangeHandler, setValue }) {
    return <div className="card">
        <div className="card-header">
            <h5 className="mb-0 h6">Add New Policy ({item.lable})</h5>
        </div>
...
export default MultiLangPolicy
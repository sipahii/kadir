jQuery(function ($) {
    ...
    $(".newsletter-form").ajaxChimp({
        url: "https://AbarisSoftech.us20.list-manage.com/subscribe/post?u=60e1ffe2e8a68ce1204cd39a5&amp;id=42d6d188d9", // Your url MailChimp
...
function setTheme(themeName) {
    localStorage.setItem('abaris_theme', themeName);
    document.documentElement.className = themeName;
}

// function to toggle between light and dark theme
function toggleTheme() {
    if (localStorage.getItem('abaris_theme') === 'theme-dark') {
